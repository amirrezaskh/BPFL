# CIFAR100-ResNet18-Uniform-FL Experiment
...
git checkout CIFAR100-ResNet18-Uniform-FL
...
- `CIFAR100-ResNet18-Uniform-0.95` - Higher personalization (γ=0.95)
...
- **Experiment ID**: cifar100_resnet18_uniform_fl
