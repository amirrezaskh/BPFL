# CIFAR100-ResNet18-Exponential-0.95 Experiment
...
git checkout CIFAR100-ResNet18-Exponential-0.95
...
- `CIFAR100-ResNet18-Exponential-FL` - Traditional FL baseline
...
- **Experiment ID**: cifar100_resnet18_exponential_0.95
