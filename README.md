# MNIST-LeNet-Linear-FL Experiment
...
git checkout MNIST-LeNet-Linear-FL
...
- `MNIST-LeNet-Linear-0.95` - Higher personalization (γ=0.95)
...
- **Experiment ID**: mnist_lenet_linear_fl
