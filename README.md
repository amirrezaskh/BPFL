# CIFAR10-ResNet18-Exponential-0.95 Experiment
...
git checkout CIFAR10-ResNet18-Exponential-0.95
...
- `CIFAR10-ResNet18-Exponential-FL` - Traditional FL baseline
...
- **Experiment ID**: cifar10_resnet18_exponential_0.95
